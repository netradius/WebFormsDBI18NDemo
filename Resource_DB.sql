...
SET IDENTITY_INSERT Resource ON;
 ...
 INSERT INTO Resource([resource_id], [resource_type], [resource_name], [culture_code], [resource_value]) VALUES (2, N'CommonTerms', N'helloWorld', N'en', N'Hello World! en');
 INSERT INTO Resource([resource_id], [resource_type], [resource_name], [culture_code], [resource_value]) VALUES (3, N'CommonTerms', N'helloWorld', N'en-US', N'Hello World! en-US');
 ...
 INSERT INTO Resource([resource_id], [resource_type], [resource_name], [culture_code], [resource_value]) VALUES (5, N'CommonTerms', N'helloWorld', N'es-US', N'Hola Mundo! es-US');
